...
class MASKS():
    ...
    def findMasks(self, loc=None, child=None, adult=None, distance=None, maxcount=None, sortKey='distance'):
        ...
        self.filteredPharmacies = sorted(
            self.filteredPharmacies, key=lambda i: (i[key]), reverse=reverse)
        return self.filteredPharmacies

    def defs(self):
        print(
            f'{self.home},{self.maskChild},{self.maskAdult}, {self.distance }km, {self.maxCount}')
