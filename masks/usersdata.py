...
class Users():
    def __init__(self,database='ddvlt02reo5ofh', user='rlyvtbvatyytvm',password='95ecf0612d9fc992a7ce3e1918ca91cd31d0f9a2a2428350e7462a7885b3b397',host='ec2-52-6-143-153.compute-1.amazonaws.com'):
        self.con=None
        ...
        # URI postgres://rlyvtbvatyytvm:95ecf0612d9fc992a7ce3e1918ca91cd31d0f9a2a2428350e7462a7885b3b397@ec2-52-6-143-153.compute-1.amazonaws.com:5432/ddvlt02reo5ofh        
    ...
    def newUser(self, name, id=111, loc=[0,0],child=100, adult=0, distance=5.0, maxcount=5,count=1):
        ...
        if ck :
            count=ck[8]
            print (f'user {name} already exist, use {count} times ({type(count)}), last is {ck[9]} replace!')
